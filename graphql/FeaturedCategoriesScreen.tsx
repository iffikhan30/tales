...
export default function FeaturedCategoriesScreen() {
  ...
  const handleCategoryPress = (categoryId: string) => {
    ...
    router.push(`/talesbycategory/${categoryId}`);
  };
  ...
  return (
    ...
    <View className="mb-8">
      <View className="flex-row justify-between items-center mb-4">
        <Text className="text-xl font-bold text-gray-800">Featured Categories</Text>
        <TouchableOpacity>
        ...
        {data?.talesCategories.map((category) => (
          ...
          >
            ...
            >
              ...
              >
                <BookOpen color="#000" size={16} />
              </View>
            </View>
            <Text className="font-bold text-gray-800 mb-1">{category.title}</Text>
